...
Java_com_vaca_myapplication_GLES3JNILib_init(JNIEnv *env, jclass clazz) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vaca_myapplication_GLES3JNILib_resize(JNIEnv *env, jclass clazz, jint width, jint height) {
    if (g_renderer) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vaca_myapplication_GLES3JNILib_step(JNIEnv *env, jclass clazz) {
    if (g_renderer) {
        g_renderer->render();
    }
}